...
def main():
    ...
    parser.add_argument('--details', type=str, default="Generate Psesudo Supervision data using skipnet",
    ...
    if ON_SERVER:
        ...
        #                 help='Synthetic Dataset path')
        parser.add_argument('--celeba_data', type=str, default=None,#'/home/cgal/testimageSFS/CelebAMask-HQ/HRcombine',
                        help='CelebA Dataset path')
       	# parser.add_argument('--celeba_data', type=str, default='./data/celeba/train/celebA_00/all/',
        #                 help='CelebA Dataset path')
        parser.add_argument('--log_dir', type=str, default='./results/',
                        help='Log Path')
    parser.add_argument('--load_model', type=str, default=None,#'./results/Synthetic_Train/checkpoints/',
    ...
    if model_dir is not None:
        skipnet_model.load_state_dict(torch.load(model_dir + 'skipnet_model_9.pkl'))
        print("using previous model")
    else:
        print('Initializing weights')
        skipnet_model.apply(weights_init)
        summary(skipnet_model, (3, 256 , 256))
    result_dir = args.log_dir+'Synthetic_Train/'
    ...
    train_synthetic(skipnet_model, syn_data, celeba_data = celeba_data, read_first=100, \
    ...
    train_dataset, test_dataset = get_celeba_dataset(dir=celeba_data ,read_from_csv=None, read_first=read_first, validation_split=2)
    ...
    out_celeba_images_dir = './dataset/HRcombine_synt_2/'
